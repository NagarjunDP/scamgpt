    ...
    <header className="h-14 border-b border-[var(--border)] bg-[var(--background)]/80 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {isNotifOpen && (
            <div
              className="absolute right-0 mt-3 w-80 bg-[#111111] border border-zinc-800 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden z-50"
              role="menu"
            >
                ...
                {notifications.length > 0 ? (
                  notifications.map((notif) => (
                    <div
                      ...
                      className={`p-4 border-b border-zinc-900 last:border-0 cursor-pointer transition-colors ${
                        notif.read
                          ? 'opacity-60 hover:bg-zinc-900/40'
                          : 'bg-[#ff0033]/5 hover:bg-[#ff0033]/10'
                      }`}
                      role="menuitem"
                    >
